...
<h3>Reservation</h3>
    ...
    <form role="form" class="wowload fadeInRight" method="post">
        ...
        <input type="submit" class="btn" style="background-color: goldenrod; color: black; border: none" value="Request a reservation" name="submit">
    </form>    
</div>
</div>  
</div>
