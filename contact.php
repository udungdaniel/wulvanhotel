...
<div class="container">
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($name) || empty($email) || empty($phone) || empty($message)) {
            ...
            // Get next id (if your DB is not AUTO_INCREMENT)
            $q = "SELECT id FROM feedback ORDER BY id DESC LIMIT 1";
            $r = mysqli_query($con, $q);
            $id = (mysqli_num_rows($r) > 0) ? (mysqli_fetch_assoc($r)['id'] + 1) : 1;
    ...
    <div class="row" style="margin-top: 40px;">
        ...
        <!-- Contact Form -->
        <div class="col-md-6">
            <h4><b></b>Write to us</b></h4>
            <label style="color: <?= htmlspecialchars($color) ?>;">
            ...
            <form method="post" action="">
                ...
                <input type="submit" class="btn" style="background-color: black; color: white; border: none; width: 100%" value="Send message" name="submit">
            </form>
        </div>
    </div>
</div>
